...
if ($item_list) {
    foreach ($item_list as $its) {

$d_html .= '
<table border="1" style=" padding: 5px;">
<tr style="border: 1px solid black;">
    <th style="font-size: 15px; padding: 10%; text-align: center;  font-weight: bold;"><b><img src="'.$its['qr'].'" style=" display: flex; margin: 0; padding: 0; line-height: 0;"></b></th>
    <th style="font-size: 15px;  padding: 10%; text-align: left;  "><b>Item:</b> '.$its['brand'].' '.$its['model'].'<br><b>Specs:</b> '.$its['specs'].'<br><b>Item Code:</b> '.$its['issuance_code'].'</th>
</tr>
</table>
';
