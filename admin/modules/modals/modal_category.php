...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header text-center">
      <h3 class="modal-title w-100 dark-grey-text font-weight-bold">Add New Category</h3>
    ...
    <form id="form_insert">
      <div class="modal-body mx-4">
        <div class="md-form">
          ...
          <input type="text" class="form-control validate" id="add_category" required>
        </div>
...
<div class="modal fade" id="list_edit_modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h3 class="modal-title w-100 dark-grey-text font-weight-bold">Edit Category</h3>
        <button type="button" class="close" data-bs-dismiss="modal" aria-lable="close">&times;</button>
      </div>
      <form id="form_update">
        <div class="modal-body mx-4">
          <div class="md-form">
          <input type="hidden" class="form-control validate" id="edit_category_id">
            <label data-error="wrong" data-success="right">Item<span class="text-danger">*</span></label>
            <input type="text" class="form-control validate" id="edit_category" required>
          </div>
          <div class="text-center mt-3">
            <button type="submit" class="btn btn-primary btn-block z-depth-1a" id="btn_add">SUBMIT</button>
          </div>
        ...
        <div class="modal-content">
            ...
            <form id="delete_form">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="" id="delete_category_id">
                </div>
